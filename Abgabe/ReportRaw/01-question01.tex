...
Each team can recruit 21 different units in their 'Commercial' or their 'Command Base' structures.
Special navy units can be bought at 'Ship Yard' structures and airborne units can be recruited at the airport.
Each unit has different static, such as health points (HP), movement ranges and types, attack ranges and recruitment prices.
There also are 'Industrial' tiles scattered around the maps which can be occupied by one of a team and grant additional money every round.
