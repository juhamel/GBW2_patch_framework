...
The base damage is calulated by loading a value from the Read Only Memory, which is dependent on the unit type of the subjected team. For the attacking unit damage this is \addr{C4D3} and for the the attacked it is \addr{C517}.
...
This value is then loaded into the B register, before loading the opposing units HP into register E and calling the procedures 00:0916 and 097D, which multiplies this previouly loaded ROM value with the opposing units HP and divides it by the fixed value of $63_{16}$ ($99_{10}$).
