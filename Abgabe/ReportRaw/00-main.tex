...
\begin{abstract}
	...
	While Game Boy Wars 2 was only released in Japan, we found an English community translation ROM online, which we used to learn the games mechanics and write cheats for it. \footnote{https://romsfun.com/roms/game-boy-color/game-boy-wars-2.html}
	For the easy appliance of the cheats, we wrote a python framework using pyboy, which grants the player a graphical user interface (GUI) to select wanted cheats.
